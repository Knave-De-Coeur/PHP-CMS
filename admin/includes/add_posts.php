...
//    $post_user         = $_POST['user'];
    ...
    $query = "INSERT INTO posts (Id, Post_Category_Id, Title, Author, Date, Image, Content, Tags, Comment_Count, Status) 
              VALUES (NULL, {$post_category_id}, '{$post_title}', '{$post_author}', now(), '{$post_image}', '{$post_content}', '{$post_tags}', {$post_comment_count}, '{$post_status}'); ";
